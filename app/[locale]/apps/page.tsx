...
const apps = [
    ...
    },
    {
        ...
        titleNo: "TANKWARS",
        titleEn: "TANKWARS",
        descNo: "Artillerispel i nettlesaren i ånda til Tank Wars (1991): øydeleggjeleg terreng, vind, femten våpen, hotseat for fire spelarar og ein kampanje med bossar. Phaser 3 og TypeScript, pikselgrafikk laga med AI.",
        descEn: "Browser artillery game in the spirit of Tank Wars (1991): destructible terrain, wind, fifteen weapons, four-player hotseat and a boss campaign. Phaser 3 and TypeScript, with AI-generated pixel art.",
        icon: "🎮",
        accentColor: "#f5a623",
        url: "https://github.com/vskeide/tankwars",
        tags: ["Phaser 3", "TypeScript", "Pixel art"],
        ctaNo: "Sjå på GitHub",
        ctaEn: "View on GitHub",
    },
    {
